...
- Persistence:
  ...
  The key used in this example project is "savedSliderValue"
...
Persistence.local.get('savedSliderValue').then((savedSliderValue) => {
	/*
...
.then(() => {
	...
	.subscribe((newSliderValue) => { // The function in .subscribe() gets executed everytime the value changes
		...
		Persistence.local.set('savedSliderValue', { value: newSliderValue });
